...
public class LoginTemplate extends JFrame{
    ...
    public void crearPaneles(){
            pCentral = S.construirJPanel(440, 100, 400, 500, Color.WHITE, R.getBborde()); 
            this.add(pCentral);
    ...
    public void crearJlabels(){
            lLogo = S.construirJLabel("", (pFondo.getWidth() - 198) / 2, 0, 198, 73, null, R.getLogo(), null, Color.WHITE, Color.BLACK, null, "");
            pFondo.add(lLogo);
